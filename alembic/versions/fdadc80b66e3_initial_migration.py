...
Revision ID: fdadc80b66e3
Revises: 
Create Date: 2026-01-10 14:43:15.708077
...
def upgrade() -> None:
    ...
    op.create_index('idx_users_role', 'users', ['organization_id', 'role'], unique=False)
    ...
    sa.Column('primary_condition', sa.Enum('DIABETES', 'HYPERTENSION', 'HEART_DISEASE', 'COPD', 'KIDNEY_DISEASE', 'ASTHMA', 'OTHER', name='condition'), nullable=False),
    sa.Column('secondary_conditions', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index('ix_patients_last_reading_at', 'patients', ['last_reading_at'], unique=False)
    op.create_index('ix_patients_organization_id', 'patients', ['organization_id'], unique=False)
    op.create_index(op.f('ix_patients_patient_uid'), 'patients', ['patient_uid'], unique=True)
    op.create_index('ix_patients_primary_condition', 'patients', ['primary_condition'], unique=False)
    ...
    op.create_index('ix_health_readings_is_anomaly', 'health_readings', ['is_anomaly'], unique=False)
    op.create_index('ix_health_readings_organization_id', 'health_readings', ['organization_id'], unique=False)
    op.create_index('ix_health_readings_patient_id', 'health_readings', ['patient_id'], unique=False)
    op.create_index('ix_health_readings_reading_time', 'health_readings', ['reading_time'], unique=False)
    op.create_index('ix_health_readings_reading_type', 'health_readings', ['reading_type'], unique=False)
    ...
    op.create_index('ix_scheduled_checks_is_active', 'scheduled_checks', ['is_active'], unique=False)
    op.create_index('ix_scheduled_checks_next_run_at', 'scheduled_checks', ['next_run_at'], unique=False)
    op.create_index('ix_scheduled_checks_patient_id', 'scheduled_checks', ['patient_id'], unique=False)
    ...
    op.create_index('ix_agent_actions_action_type', 'agent_actions', ['action_type'], unique=False)
    op.create_index('ix_agent_actions_created_at', 'agent_actions', ['created_at'], unique=False)
    op.create_index('ix_agent_actions_organization_id', 'agent_actions', ['organization_id'], unique=False)
    op.create_index('ix_agent_actions_patient_id', 'agent_actions', ['patient_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_agent_actions_organization_id', table_name='agent_actions')
    ...
    op.drop_index('ix_scheduled_checks_patient_id', table_name='scheduled_checks')
    op.drop_index('ix_scheduled_checks_next_run_at', table_name='scheduled_checks')
    op.drop_index('ix_scheduled_checks_is_active', table_name='scheduled_checks')
    op.drop_table('scheduled_checks')
    op.drop_index('ix_health_readings_reading_type', table_name='health_readings')
    op.drop_index('ix_health_readings_reading_time', table_name='health_readings')
    op.drop_index('ix_health_readings_patient_id', table_name='health_readings')
    op.drop_index('ix_health_readings_organization_id', table_name='health_readings')
    op.drop_index('ix_health_readings_is_anomaly', table_name='health_readings')
    ...
    op.drop_index('ix_patients_primary_condition', table_name='patients')
    ...
    op.drop_index('ix_patients_last_reading_at', table_name='patients')
